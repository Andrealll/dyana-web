...
// ===============================================================
// 📊 LETTURA CREDITS STATE (da astrobot_auth)
// ===============================================================
export async function fetchCreditsState(token) {
  const res = await fetch(`${AUTH_BASE}/credits/state`, {
    method: "GET",
    headers: {
...
// ===============================================================
// 📜 LETTURA STORICO USAGE + PURCHASES
// ===============================================================
export async function fetchUsageHistory(token) {
  const res = await fetch(`${AUTH_BASE}/usage/history`, {
    method: "GET",
    headers: {
      Authorization: `Bearer ${token}`,
    },
