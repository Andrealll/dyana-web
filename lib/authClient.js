...
function getSupabaseRedirectUrl() {
  ...
  //    → in prod sarà SEMPRE https://dyana.app/reset_password
  if (typeof window !== "undefined") {
    return `${window.location.origin}/reset_password`;
  }

  // 2️⃣ Fallback per SSR/build (es. durante build Next)
  //    Mettiamo direttamente l'URL prod
  return "https://dyana.app/reset_password";
}
